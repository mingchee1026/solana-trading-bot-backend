...
export class PoolCache {
  private readonly keys: Map<string, { id: string; state: LiquidityStateV4 }> =
    new Map<string, { id: string; state: LiquidityStateV4 }>();
  ...
  public async get(
    mint: string,
  ): Promise<{ id: string; state: LiquidityStateV4 }> {
